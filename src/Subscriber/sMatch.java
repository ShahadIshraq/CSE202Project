 ...
 */
public class sMatch implements Serializable {
    String firstTeam;
    String lastTeam;
    int scoreFirst;
    int scoreLast;
    ...
    public sMatch(String firstTeam, String lastTeam){
